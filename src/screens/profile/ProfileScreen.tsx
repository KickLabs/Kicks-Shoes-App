    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.iconRow}>
          <TouchableOpacity style={styles.profileIconContainer} onPress={() => navigation.navigate("OrderHistory")}> 
            <Ionicons name="bag-outline" size={28} color="#222" />
            <Text style={styles.profileIconLabel}>Orders</Text>
          </TouchableOpacity>
